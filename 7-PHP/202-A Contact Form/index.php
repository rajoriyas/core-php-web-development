<?php
  ...
  if ($error != "") {
    $error = '<div class="alert alert-danger" role="alert"><strong>There were following error(s) found in form:</strong><br>'.$error.'</div>';
  } elseif ($error == "" && $_POST) {
      $header = "From: rajoriya.rahul04@hotmail.com\r\n";
      if(mail($_POST['email'], $_POST['subject'], $_POST['content'], $header)) {
        $success .= '<div class="alert alert-primary" role="alert"><strong>Send Successfully</strong></div>';
      } else {
          $error .= '<div class="alert alert-danger" role="alert"><strong>Sending Failed</strong></div>';
        }
    }
?>
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    /*  $("form").submit(function(e){
        e.preventDefault(); //if form validation is Successfully
        var error = "";
    ...
    /*    if($("#exampleInputEmail1").val() == "") {
        ...
        if (error != "") {
          ...
          $("form").unbind("submit").submit();  //if form validation is Successfully
        }
